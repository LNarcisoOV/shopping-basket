...
public class BasketTest {
	...
	void consolidateBasketTest() {
		...
		List<BasketItem> basketSize = basket.getConsolidatedItems();
		...
		assertEquals(basketSize.get(2).getProductCode(), "productCode3");
		assertEquals(basketSize.get(2).getProductName(), "myProduct3");
		assertEquals(basketSize.get(2).getQuantity(), 60);
		assertEquals(basketSize.get(3).getProductCode(), "productCode4");
